...
import { Eye, EyeOff, Loader2, Mail, MessageSquare, Lock } from 'lucide-react'; // Import Lock
...
function LogInPage() {
  ...
  const { login, isLoggingIn } = useAuthStore(); // Fixed typo: isLoggingIng -> isLoggingIn
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <h1 className="text-2xl font-bold mt-2">Log In</h1> {/* Changed text to "Log In" */}
